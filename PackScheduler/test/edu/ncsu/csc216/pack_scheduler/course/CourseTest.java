...
public class CourseTest {
	...
	public void testCompareTo() {
		...
		Course c3 = new Course("CSC116", TITLE, SECTION, CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
		Course c4 = new Course(NAME, TITLE, "002", CREDITS, INSTRUCTOR_ID, MEETING_DAYS, START_TIME, END_TIME);
		//Test for compareTo on same course
		assertEquals(0, c1.compareTo(c2));
		assertEquals(0, c2.compareTo(c1));
		
		//Test for compareTo on different course names
